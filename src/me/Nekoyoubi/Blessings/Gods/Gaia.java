...
public class Gaia extends God {
	public Gaia() {
		...
		favors.add(new Favor(50, "heal", "world", "20", "")); // Heals the world.
		
		favors.add(new Favor(250, "feed", "player;random;random", "20", "")); // Feeds the player and two random players.
		favors.add(new Favor(50, "feed", "world", "20", "")); // Feeds the world.
		...
		favors.add(new Favor(50, "give", "player", "295x3", "")); // Three seeds.
		favors.add(new Favor(50, "give", "player", "295x3", "")); // Three seeds.
		favors.add(new Favor(50, "give", "player", "295x3", "")); // Three seeds.
		favors.add(new Favor(20, "give", "player", "6x3", "")); // Three saplings.
		favors.add(new Favor(20, "give", "player", "6:1x3", "")); // Three saplings.
		favors.add(new Favor(20, "give", "player", "6:2x3", "")); // Three saplings.
		favors.add(new Favor(30, "give", "player", "106x10", "")); // Ten vines.
		favors.add(new Favor(30, "give", "player", "81x10", "")); // Ten cacti.
		favors.add(new Favor(30, "give", "player", "338x10", "")); // Ten cane.
		...
		favors.add(new Favor(20, "give", "player", "292", "")); // An iron hoe.
		favors.add(new Favor(20, "give", "player", "256", "")); // An iron shovel.
		favors.add(new Favor(20, "give", "player", "326", "")); // A bukkit of water.
		...
		curses.add(new Favor(50, "hunger", "random", "1", "")); // Hungers a random player.
