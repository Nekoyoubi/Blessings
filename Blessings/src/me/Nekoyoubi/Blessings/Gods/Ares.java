...
public class Ares extends God {
	public Ares() {
		...
		favors.add(new Favor(500, "give", "player", "351:1", "")); // One red dye.
		favors.add(new Favor(250, "give", "player", "351:1", "")); // One red dye.
		favors.add(new Favor(250, "give", "player", "351:1", "")); // One red dye.
		favors.add(new Favor(50, "give", "player", "262x10", "")); // Ten arrows.
		favors.add(new Favor(50, "give", "player", "262x10", "")); // Ten arrows.
		favors.add(new Favor(20, "give", "player", "35:14x10", "")); // Ten red wool.
		favors.add(new Favor(20, "give", "player", "101x10", "")); // Ten 'bars' blocks.
		favors.add(new Favor(30, "give", "player", "261", "")); // One bow.
		favors.add(new Favor(20, "give", "player", "258", "")); // An iron axe.
		favors.add(new Favor(30, "give", "player", "267", "")); // An iron sword.
		favors.add(new Favor(10, "give", "player", "262x64", "")); // A stack (64) of arrows.
		favors.add(new Favor(10, "give", "player", "46", "")); // A block of TNT.
